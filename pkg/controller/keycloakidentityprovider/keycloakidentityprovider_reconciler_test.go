...
func TestKeycloakIdentityProviderReconciler_Test_Creating_Client(t *testing.T) {
	// given
	keycloakCr := v1alpha1.Keycloak{}
	cr := &v1alpha1.KeycloakIdentityProvider{
		ObjectMeta: v13.ObjectMeta{
			Name:      "test",
			Namespace: "test",
		},
		Spec: v1alpha1.KeycloakIdentityProviderSpec{
	...
	// when
	reconciler := NewKeycloakIdentityProviderReconciler(keycloakCr)
...
func TestKeycloakIdentityProviderReconciler_Test_PartialUpdate_Client(t *testing.T) {
	// given
	keycloakCr := v1alpha1.Keycloak{}
	cr := &v1alpha1.KeycloakIdentityProvider{
		ObjectMeta: v13.ObjectMeta{
...
func TestKeycloakIdentityProviderReconciler_Test_Delete_Client(t *testing.T) {
	// given
	keycloakCr := v1alpha1.Keycloak{}
	cr := &v1alpha1.KeycloakIdentityProvider{
		ObjectMeta: v13.ObjectMeta{
...
func TestKeycloakIdentityProviderReconciler_Test_Update_Client(t *testing.T) {
	// given
	keycloakCr := v1alpha1.Keycloak{}
	cr := &v1alpha1.KeycloakIdentityProvider{
		ObjectMeta: v13.ObjectMeta{
	...
	currentState := &common.ClientState{
		...
		AvailableClientScopes: []v1alpha1.KeycloakIdentityProviderScope{{Name: "address", ID: "222"}, {Name: "email", ID: "421"}, {Name: "profile", ID: "314"}},
		DefaultClientScopes:   []v1alpha1.KeycloakIdentityProviderScope{},
		OptionalClientScopes:  []v1alpha1.KeycloakIdentityProviderScope{{Name: "address", ID: "222"}},
	}
...
func TestKeycloakIdentityProviderReconciler_Test_Marshal_Client(t *testing.T) {
	// given
	cr := &v1alpha1.KeycloakIdentityProvider{
		ObjectMeta: v13.ObjectMeta{
			Name:      "test",
...
func TestKeycloakIdentityProviderReconciler_Test_ScopeMapping_Difference(t *testing.T) {
	// given
