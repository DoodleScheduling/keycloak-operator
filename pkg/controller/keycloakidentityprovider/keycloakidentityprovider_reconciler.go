...
type Reconciler interface {
	Reconcile(cr *kc.KeycloakIdentityProvider) error
}
...
func (i *KeycloakIdentityProviderReconciler) Reconcile(state *common.ClientState, cr *kc.KeycloakIdentityProvider) common.DesiredClusterState {
...
func (i *KeycloakIdentityProviderReconciler) ReconcileRoles(state *common.ClientState, cr *kc.KeycloakIdentityProvider, desired *common.DesiredClusterState) {
...
func (i *KeycloakIdentityProviderReconciler) ReconcileScopeMappings(state *common.ClientState, cr *kc.KeycloakIdentityProvider, desired *common.DesiredClusterState) {
...
func (i *KeycloakIdentityProviderReconciler) ReconcileClientScopes(state *common.ClientState, cr *kc.KeycloakIdentityProvider, desired *common.DesiredClusterState) {
...
func (i *KeycloakIdentityProviderReconciler) getDeletedClientState(state *common.ClientState, cr *kc.KeycloakIdentityProvider) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getCreatedClientState(state *common.ClientState, cr *kc.KeycloakIdentityProvider) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getUpdatedClientSecretState(state *common.ClientState, cr *kc.KeycloakIdentityProvider) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getUpdatedClientState(state *common.ClientState, cr *kc.KeycloakIdentityProvider) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getCreatedClientSecretState(state *common.ClientState, cr *kc.KeycloakIdentityProvider) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getCreatedClientRoleState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, role *kc.RoleRepresentation) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getUpdatedClientRoleState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, role, oldRole *kc.RoleRepresentation) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getDeletedClientRoleState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, role *kc.RoleRepresentation) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getCreatedClientRealmScopeMappingsState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, mappings *[]kc.RoleRepresentation) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getDeletedClientRealmScopeMappingsState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, mappings *[]kc.RoleRepresentation) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getCreatedClientClientScopeMappingsState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, mappings *kc.ClientMappingsRepresentation) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getDeletedClientClientScopeMappingsState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, mappings *kc.ClientMappingsRepresentation) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getCreatedClientDefaultClientScopeState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, clientScope *kc.KeycloakIdentityProviderScope) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getCreatedClientOptionalClientScopeState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, clientScope *kc.KeycloakIdentityProviderScope) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getDeletedClientDefaultClientScopeState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, clientScope *kc.KeycloakIdentityProviderScope) common.ClusterAction {
...
func (i *KeycloakIdentityProviderReconciler) getDeletedClientOptionalClientScopeState(state *common.ClientState, cr *kc.KeycloakIdentityProvider, clientScope *kc.KeycloakIdentityProviderScope) common.ClusterAction {
