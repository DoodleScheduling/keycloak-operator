...
func (c *FakeKeycloakV1alpha1) KeycloakIdentityProviders(namespace string) v1alpha1.KeycloakIdentityProviderInterface {
	return &FakeKeycloakIdentityProviders{c, namespace}
}
