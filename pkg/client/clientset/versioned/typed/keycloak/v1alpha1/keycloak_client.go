...
type KeycloakV1alpha1Interface interface {
	...
	KeycloakIdentityProvidersGetter
...
func (c *KeycloakV1alpha1Client) KeycloakBackups(namespace string) KeycloakBackupInterface {
	return newKeycloakBackups(c, namespace)
}
...
func (c *KeycloakV1alpha1Client) KeycloakIdentityProviders(namespace string) KeycloakIdentityProviderInterface {
	return newKeycloakIdentityProviders(c, namespace)
}
...
func (c *KeycloakV1alpha1Client) KeycloakUsers(namespace string) KeycloakUserInterface {
	return newKeycloakUsers(c, namespace)
}
